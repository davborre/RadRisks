...
for file in files:
  with file.open('r') as file_handle:
    ...
    radionuclideWithDash = fileName[:(period - 1)]
    radionuclide = radionuclideWithDash[:radionuclideWithDash.find("-")] + radionuclideWithDash[radionuclideWithDash.find("-") + 1:]
    ...
    for line in file_handle:
      if line.find("Cancer site:") == 0:
        ...
        with open(outputFileName, "a") as output_file:
          ...
          output_file.write("pub fn " + radionuclide + absorptionType + cancer + "() -> HashMap<u8, [f32;6]> {\n")
